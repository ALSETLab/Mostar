...
equation
  ...
  connect(pSS2B.VOTHSG, sT5B.VOTHSG) annotation (Line(points={{-77,3},{-83.5,3},
          {-83.5,20.6},{-113,20.6}}, color={0,0,127}));
  ...
  connect(add3_3.u2, r3) annotation (Line(points={{-17.2,9.6},{0.4,9.6},{0.4,0},
          {34,0}}, color={0,0,127}));
  connect(sT5B.XADIFD, r1) annotation (Line(points={{-132,7.1},{-132,2},{-150,2},
          {-150,-50},{-172,-50}}, color={0,0,127}));

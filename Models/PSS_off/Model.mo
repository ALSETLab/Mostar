...
model Model
  ...
  Modelica.Blocks.Discrete.Sampler Qsampler(samplePeriod=126.5/254)
...
equation
  ...
  connect(feedback1.u2, Qout_real.y[1])
    annotation (Line(points={{100,2},{100,-20},{81,-20}}, color={0,0,127}));
  connect(Pout_real.y[1], feedback.u2)
    annotation (Line(points={{81,40},{100,40},{100,62}}, color={0,0,127}));
  connect(Vim_input.y[1], voltageSource.u1) annotation (Line(points={{-3,60},{
          -14,60},{-14,46},{-28,46}}, color={0,0,127}));
  connect(voltageSource.u2, Vreal_input.y[1]) annotation (Line(points={{-28,38},
          {-16,38},{-16,22},{-3,22}}, color={0,0,127}));

...
model Model
  Modelica.Blocks.Interfaces.RealOutput Pout
    annotation (Placement(transformation(extent={{-40,2},{-32,10}}),   iconTransformation(
          extent={{-40,2},{-32,10}})));
  Modelica.Blocks.Interfaces.RealOutput Qout
    annotation (Placement(transformation(extent={{-26,2},{-18,10}})));
  ...
  Modelica.Blocks.Math.Add3 add3_1 annotation (Placement(transformation(extent={{-84,-12},
            {-92,-4}})));
  Modelica.Blocks.Sources.Step step1(               height=-0.05, startTime=2.67)
                                                                   annotation (Placement(transformation(extent={{-66,-20},
            {-74,-12}})));
  Modelica.Blocks.Sources.Step step(                height=0.05, startTime=11.83)

...
model Model
  Modelica.Blocks.Interfaces.RealOutput Pout
    annotation (Placement(transformation(extent={{-30,-22},{-22,-14}}),iconTransformation(
          extent={{-30,-22},{-22,-14}})));
  Modelica.Blocks.Interfaces.RealOutput Qout
    annotation (Placement(transformation(extent={{-16,-22},{-8,-14}})));
  Data2Model.PQLim06.init machineData
  ...
  Modelica.Blocks.Math.Add  add3_1 annotation (Placement(transformation(extent={{-66,-14},
            {-74,-6}})));
  Modelica.Blocks.Sources.Step step1(startTime=10,  height=0.0278) annotation (Placement(transformation(extent={{-48,-20},
            {-56,-12}})));
...
equation
  ...
  connect(add3_1.u2,step1. y) annotation (Line(points={{-65.2,-12.4},{-58,-12.4},

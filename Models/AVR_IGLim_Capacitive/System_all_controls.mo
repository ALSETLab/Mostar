...
equation
  ...
  connect(sT5B.VOTHSG, pSS2B.VOTHSG) annotation (Line(points={{-54,-23.5},{-46,
          -23.5},{-46,-47},{-44.3158,-47}},     color={0,0,127}));
  connect(pSS2B.V_S1, gENSAL.ETERM) annotation (Line(points={{-24.3158,-45.5},{
          -22,-45.5},{-22,-28},{-32,-28},{-32,-3.6},{-46.8,-3.6}}, color={0,
          0,127}));
  connect(pSS2B.V_S2, gENSAL.ETERM) annotation (Line(points={{-24.3158,-48.5},{

...
protected
    Optimization.Internal.Version.V22.ModelOptimizationSetup setup=Optimization.Internal.Version.V22.ModelOptimizationSetup(
    ...
    criteria={Optimization.Internal.Version.V22.Criterion(
        ...
        usage=Optimization.Internal.Version.V22.Types.CriterionUsage.Minimize,
        demand=1.0,
        unit="1"),Optimization.Internal.Version.V22.Criterion(name="Efd_error.y",
        unit="1"),Optimization.Internal.Version.V22.Criterion(name="Ifd_error.y",active=false,
        unit="1")},

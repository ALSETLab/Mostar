...
model GENSAL "SALIENT POLE GENERATOR MODEL (QUADRATIC SATURATION ON D-AXIS)"
  ...
  extends OpenIPSL.Electrical.Machines.PSSE.BaseClasses.baseMachine(
    ...
    uq(start=uq0),
    Te(start=pm0));
  OpenIPSL.Types.PerUnit Epq(start=Epq0)
    "q-axis voltage behind transient reactance";
  OpenIPSL.Types.PerUnit PSIkd(start=PSIkd0) "d-axis rotor flux linkage";
  OpenIPSL.Types.PerUnit PSIppq(start=PSIppq0)
    "q-axis subtransient flux linkage";
  OpenIPSL.Types.PerUnit PSIppd(start=PSIppd0)
    "d-axis subtransient flux linkage";
  OpenIPSL.Types.PerUnit PSId(start=PSId0) "d-axis flux linkage";
  OpenIPSL.Types.PerUnit PSIq(start=PSIq0) "q-axis flux linkage";
  OpenIPSL.Types.PerUnit XadIfd(start=efd0) "Machine field current";
protected
  ...
  parameter OpenIPSL.Types.PerUnit ud0=v_0*cos(angle_0 - delta0 + Modelica.Constants.pi
      /2) "d-axis component of initial voltage";
  parameter OpenIPSL.Types.PerUnit uq0=v_0*sin(angle_0 - delta0 + Modelica.Constants.pi
      /2) "q-axis component of initial voltage";
  parameter Complex PSIpp0_dq=real(PSIpp0*DQ_dq) + j*imag(PSIpp0*DQ_dq)
    "Flux linkage in rotor reference frame";
  parameter OpenIPSL.Types.PerUnit PSIppq0=-imag(PSIpp0_dq)
    "q-axis component of the sub-transient flux linkage";
  parameter OpenIPSL.Types.PerUnit PSIppd0=real(PSIpp0_dq)
    "d-axis component of the sub-transient flux linkage";
  parameter OpenIPSL.Types.PerUnit PSIkd0=(PSIppd0 - (Xpd - Xl)*K3d*id0)/(K3d
       + K4d) "d-axis initial rotor flux linkage";
  parameter OpenIPSL.Types.PerUnit PSId0=PSIppd0 - Xppd*id0;
  parameter OpenIPSL.Types.PerUnit PSIq0=(-PSIppq0) - Xppq*iq0;
  //Initialization mechanical power and field voltage.
  parameter OpenIPSL.Types.PerUnit Epq0=uq0 + Xpd*id0 + R_a*iq0;
  parameter Real dsat=SE(
      ...
      1,
      1.2);
  parameter OpenIPSL.Types.PerUnit efd0=Epq0*(1 + dsat) + (Xd - Xpd)*id0
    "Initial field voltage magnitude";
  parameter OpenIPSL.Types.PerUnit pm0=p0 + R_a*iq0*iq0 + R_a*id0*id0

...
%Output data
rapidSettings.experimentData.pathToReferenceData = 'PQLim02_Efd.mat'; %Data file name
...
rapidSettings.experimentSettings.pathToFMUModel = 'AVR_fmu.fmu'; %FMU file name
rapidSettings.experimentSettings.modelName = 'Mostar'; %Simulink model name
rapidSettings.experimentSettings.blockName = 'Mostar/AVR_fmu'; %FMU name
...
p_0 =[1.7216     0.201002      9.84703      1.97195     0.563883      1.87382      1.46865      1.01967      13.1416       8.8876      2.06749     0.401413...
      17.08745      10.19769      254.4438       3.68203      110.3425]; %Maximum values of parameters
...
rapidSettings.fmuOutputNames = {'Pout','Qout','Efd'}; %Output variable names

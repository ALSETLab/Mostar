...
%Output data
rapidSettings.experimentData.pathToReferenceData = 'RaPId_data.mat'; %Data file name
...
%Input data
rapidSettings.experimentData.pathToInData = 'RaPId_data.mat';
...
rapidSettings.experimentSettings.pathToSimulinkModel = 'Mostar_RaPId.slx'; %Simulink model file name
rapidSettings.experimentSettings.pathToFMUModel = 'fmu.fmu'; %FMU file name
rapidSettings.experimentSettings.modelName = 'Mostar_RaPId'; %Simulink model name
rapidSettings.experimentSettings.blockName = 'Mostar_RaPId/fmu'; %FMU name
...
rapidSettings.fmuInputNames = {'Efd','P','Q'}; %Input variable names
rapidSettings.fmuOutputNames = {'Vt','Ifd','speed'}; %Output variable names

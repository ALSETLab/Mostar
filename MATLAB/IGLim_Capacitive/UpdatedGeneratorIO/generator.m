...
nexttile;
plot(t,V,'k',t,x(:,1),'r','LineWidth',1);ylabel('Voltage (p.u.)','FontSize',16); xlim([0 4]);
nexttile;
plot(t,Ifd,'k',t,x(:,2),'r','LineWidth',1);ylabel('Ifd (p.u.)','FontSize',16);legend('Data','Model','FontSize',16); xlim([0 4]);
nexttile;
plot(t,speed,'k',t,x(:,3),'r','LineWidth',1);ylabel('Speed deviation (p.u.)','FontSize',16);xlabel('Time (s)','FontSize',16); xlim([0 4]);

...
%Output data
rapidSettings.experimentData.pathToReferenceData = 'PQ_Lim_04.mat'; %Data file name
...
x=1;
y = 12;
p_0 =[1.1183	0.004799183673	2.137	0.371	0	0.62	0.241	0.215	3.77	0.0552	0.0823	0.1...
      0.01	2	20	0.02	0.005	500	 0.005	1	4.35	-3.825]; %Maximum values of parameters
p_min = [0.6,0.0001,2,0.1,0.01,0.1,0.1,0.1,1,0.1,0.1,0.01,...
         0, 0.5,3,1e-3,1e-3,300,1e-6,0.1,1e-4,-11];%Minimum values of parameters
p_max =[1.5,0.1,5,1,0.1,1.25,1.25,1.25,5,2,2,1,...

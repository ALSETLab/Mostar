...
r1 = 0*r(1:1501);%0.1
r2 = 0*r(1502:3002);%0.005
r3 = 0*r(3003:4503);%0.01
load gen_ss_RaPId 
load gen_ss_Mostar
...
nexttile;
plot(t,V,'k',t,x(:,1),'b',t,z(:,1),'r',t,y(:,1),'g','LineWidth',1);ylabel('Voltage (p.u.)','FontSize',13); xlim([0 7.5]);
nexttile;
plot(t,Ifd,'k',t,x(:,2),'b',t,z(:,2),'r',t,y(:,2),'g','LineWidth',1);ylabel('Ifd (p.u.)','FontSize',13);legend('Data','Mostar System','OE model','RaPId model','FontSize',11); xlim([0 7.5]);
nexttile;
plot(t,speed,'k',t,x(:,3),'b',t,z(:,3),'r',t,y(:,3),'g','LineWidth',1);ylabel('Speed deviation (p.u.)','FontSize',13);xlabel('Time (s)','FontSize',13); xlim([0 7.5]);

figure(10);tiledlayout(3,1);
nexttile;
plot(t,Efd,'LineWidth',1);ylabel('Field voltage (p.u.)','FontSize',13); xlim([0 7.5]);
nexttile;
plot(t,P,'LineWidth',1);ylabel('Active Power (p.u.)','FontSize',13);xlim([0 7.5]);
nexttile;
plot(t,Q,'LineWidth',1);ylabel('Reactive Power (p.u.)','FontSize',13);xlabel('Time (s)','FontSize',13); xlim([0 7.5]);
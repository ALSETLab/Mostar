...
load('PSS_ON_Generator_Validation','Efd','Vt')
%%
t=time;
%Efd = Efd_Generator_Input;
Xd = 1.183; 
R_a= 0.0045;
H = 2.137;
D = 0;
...
figure(1); plot(time, Efd,'color','b','LineWidth',1);xlabel('Time (s)','FontSize',14);ylabel('Field voltage, E_{fd} (p.u.)','FontSize',14);
...
nexttile;
plot(t,P_ch,'k',t,P_sim,'r','LineWidth',1);ylabel('Active Power, P_{elec} (p.u.)','FontSize',13); legend('Data',fit_true_P_val,fit_ch_P_val,'FontSize',13,'Location','southeast'); xlabel('Time (s)','FontSize',13); 
nexttile;
plot(t,Q_ch,'k',t,Q_sim,'r','LineWidth',1);ylabel('Reactive Power, Q (p.u.)','FontSize',13);xlabel('Time (s)','FontSize',13); legend('Data',fit_true_Q_val,fit_ch_Q_val,'FontSize',13,'Location','southeast');xlabel('Time (s)','FontSize',13); 
nexttile;
plot(t,Vt_ch,'k',t,Vt_sim,'r','LineWidth',1);ylabel('Voltage (p.u.)','FontSize',13);  legend('Data',fit_true_V_val,fit_ch_V_val,'FontSize',13,'Location','southeast');xlabel('Time (s)','FontSize',13); 


figure(11);tiledlayout(3,1);
nexttile;
plot(t,P_ch,'k',t,P_sim,'r','LineWidth',1);ylabel('Active Power, P_{elec} (p.u.)','FontSize',13); legend('Data','Model','FontSize',11,'Location','southeast');xlabel('Time (s)','FontSize',13); 
nexttile;
plot(t,Q_ch,'k',t,Q_sim,'r','LineWidth',1);ylabel('Reactive Power, Q (p.u.)','FontSize',13);xlabel('Time (s)','FontSize',13); 
nexttile;
plot(t,Vt_ch,'k',t,Vt_sim,'r','LineWidth',1);ylabel('Voltage (p.u.)','FontSize',13);  xlabel('Time (s)','FontSize',13); 

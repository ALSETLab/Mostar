...
figure(5); compare(data,sys_MOSTAR,'b',modeloe,'r',sys_est,'g',model_grey,'k');legend('Data','Mostar system','OE model','RaPId model','Grey-box model');

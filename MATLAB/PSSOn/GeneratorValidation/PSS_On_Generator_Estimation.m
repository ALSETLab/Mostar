...
rapidSettings.experimentSettings.pathToSimulinkModel = 'Mostar_RaPId.mdl'; %Simulink model file name
...
p_max =[1.183*1.12, 0.004799183673*1.1,	2.137*1.1,	0.371*1.1,	0*1.1,	0.62*1.1,	0.241*1.1,	0.215*1.1,	3.77*1.1,	1.0552*1.1,	0.0823*1.1,	0.1*1.1,...

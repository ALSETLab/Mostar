...
%Output data
rapidSettings.experimentData.pathToReferenceData = 'AVR_MR_Ifmax_short.mat'; %Data file name
...
%% ==========Experiment settings==========
%General settings 
rapidSettings.experimentSettings.tf = 272/2; %Simulation length
rapidSettings.experimentSettings.ts = 0.5; %Sampling time
...
p_0 =[1.7216     0.201002      9.84703      1.97195     0.563883      1.87382      1.46865      1.01967      13.1416       8.8876      2.06749     0.401413...
      8.040634      15.81217      169.7068      3.757937     4.0361  66.1894   83.45   20]; %Maximum values of parameters
